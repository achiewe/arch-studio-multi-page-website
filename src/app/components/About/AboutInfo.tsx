...
export default function AboutInfo() {
  return (
    <div className="w-full flex flex-col gap-[20px] mb-[76px] md:justify-center md:items-center md:mb-[200px] lg:w-[1110px] lg:items-start">
      <div className="flex flex-col md:w-[573px] md:relative md:justify-center md:items-center">
        ...
        <div className="flex w-full px-[32px] flex-col gap-[21px] md:absolute md:bg-[#FFFFFF] md:w-[572px] md:bottom-0 md:left-[155px] md:pt-[88px] md:px-[59px] md:gap-[38px] lg:gap-[50px] lg:w-[793px] lg:pt-[160px] lg:pl-[183px] lg:left-[400px] lg:pr-[165px]">
