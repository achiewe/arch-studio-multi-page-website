...
export default function Heritage() {
  return (
    <div className="flex flex-col w-full px-[32px] items-start gap-[68px] mb-[112px] md:gap-[49px] md:w-[573px] md:px-0 md:items-start md:justify-center md:mb-[231px] lg:w-[1110px] lg:flex-row lg:items-start lg:justify-between">
      ...
      <div className="flex flex-col lg:gap-[82px]">
        ...
        <div className="w-full flex flex-col gap-[22px] items-start md:gap-[62px]">
          ...
          <p className="text-[18px] text-[#1B1D23] font-medium leading-[24px]">
