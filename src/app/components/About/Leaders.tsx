...
export default function Leaders() {
  return (
    <div className="w-full flex flex-col px-[32px] gap-[55px] mb-[171px] md:px-0 md:gap-[49px] md:w-[573px] md:mb-[239px] lg:flex-row lg:w-[970px] xl:w-[1110px] lg:items-start lg:gap-0 lg:justify-between lg">
