...
export default function ContactDetails() {
  return (
    <div className="flex flex-col w-full px-[32px] items-start gap-[68px] mb-[71px] md:gap-[49px] md:px-0 md:w-[573px] md:mb-[226px] lg:w-[1110px] lg:flex-row">
      <hr className="w-[65px] h-[1px] bg-[#C8CCD8] border-none lg:hidden" />
      <div className="w-full flex flex-col gap-[40px] items-start md:gap-[42px] lg:flex-row">
        <hr className="hidden lg:flex w-[65px] h-[1px] bg-[#C8CCD8]" />
        ...
        <div className="flex flex-col gap-[43px] md:flex-row md:justify-between md:gap-0 md:items-end md:w-full lg:flex-col lg:gap-[59px] lg:items-start">
