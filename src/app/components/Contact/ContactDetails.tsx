...
export default function ContactDetails() {
  return (
    <div className="flex flex-col w-full px-[32px] items-start gap-[68px] mb-[71px] md:gap-[49px] md:px-0 md:w-[573px] md:mb-[226px] lg:w-[1110px] lg:gap-[73px]">
      ...
      <div className="w-full flex flex-col gap-[40px] items-start md:gap-[42px] lg:flex-row lg:gap-[30px]">
        <div className="flex flex-col lg:gap-[73px]">
          <h1 className="text-[48px] text-[#1B1D23] font-bold leading-[52px] tracking-[ -1.714px] md:text-[72px] md:leading-[64px] md:tracking-[-2px] md:w-[300px] lg:w-[350px]">
            Contact Details
          </h1>
        </div>
