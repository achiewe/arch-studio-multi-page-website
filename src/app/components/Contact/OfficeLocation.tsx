...
// component location map for contact
export default function OfficeLocation() {
  ...
  return (
    <div className="w-full h-[367px] mb-[73px] md:h-[572px] md:w-[560px] md:mb-[199px] lg:w-[970px] xl:w-[1110px] lg:h-[560px] lg:mb-[159px]">
      <MapContainer
