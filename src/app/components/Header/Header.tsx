...
export default function Header(): JSX.Element {
  ...
  //header component
  return (
    <header className="flex flex-row p-[32px] justify-between w-full items-center md:gap-[79px] md:justify-center md:py-[56px] md:px-0 md:relative lg:max-w-[1110px] lg:gap-[94px] lg:justify-start">
