...
export default function AboutTeam() {
  return (
    <div className="w-full h-[560px] bg-SmallTeamMob bg-no-repeat bg-cover flex justify-center flex-col gap-[23px] items-start px-[32px] relative mb-[73px] md:w-[573px] md:bg-SmallTeamTab md:gap-[30px] md:px-[58px]">
