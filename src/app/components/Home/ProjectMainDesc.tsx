...
export default function ProjectMainDesc(): JSX.Element {
  return (
    <div className="w-full flex flex-col gap-[22px] px-[32px] items-start mb-[113px] relative md:gap-[43px] md:w-[572px] md:px-0 md:mb-[233px] lg:flex-row lg:max-w-[1110px] lg:items-end lg:gap-0">
